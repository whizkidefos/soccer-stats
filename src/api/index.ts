...
//const getDateMonth = todaysDate.getMonth() + 1;
...
//     const newsData = await fetch(`https://newsapi.org/v2/everything?q=football&apiKey=${process.env.NEWS_API_TOKEN}`,{next:{revalidate:30}});
